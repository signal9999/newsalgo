...
2. **このファイル（newsalgo_knowledge_v4.md）をアップロード**してから作業開始
...
- [ ] バックテスト: LLM モード検証（`--llm` フラグ使用・API コスト試算）
- [ ] バックテスト: hold_days 最適化（1/3/5 日比較）
- [ ] Slack/LINE: 実トークン設定・本番通知テスト
- [ ] Redis: Docker Compose 本番起動・TTL チューニング
